		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li><a href="##.php">Notification</a></li>
					  <li><a href="login.php">Login</a></li>
			          <li class="menu-has-children"><a href="">Course</a>
			            <ul>
		              		<li class="menu-has-children"><a href="">University</a>
					            <ul>
					              <li><a href="#">CU</a></li>
					              <li><a href="#">MG</a></li>
								  <li><a href="#">KTU</a></li>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="reg.php"> Register </a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="col-md-6 col-lg-4">
		      	...
		      	<p class="text-center">Sign in by entering the information below</p>
		      		...
		      		<div class="form-group">
                            ...
                            <label for="name"><b><h3> Name:</h3></b></label><br>
                            <input type="text" name="name" id="name" class="form-control form-control-lg"  required>
                        
		      		</div>
					<div class="form-group">
		      			
                            <label for="name"><b><h3> Address:</h3></b></label><br>
                            <input type="text" name="address" id="address" class="form-control form-control-lg"  required>
                        
		      		</div>
					<div class="form-group">
		      			
                            <label for="name"><b><h3> DOB:</h3></b></label><br>
                            <input type="date" name="dob" id="dob" class="form-control form-control-lg"  required>
                        
		      		</div>
					<div class="form-group">
		      			
                            <label for="name"><b><h3> Email:</h3></b></label><br>
                            <input type="text" name="email" id="email" class="form-control form-control-lg" required>
                        
		      		</div>
					<div class="form-group">
		      			
                            <label for="name"><b><h3> Phone No:</h3></b></label>
                            <input type="text" name="p_no" id="p_no" class="form-control form-control-lg" required>
                        
		      		</div>
					
	            <div class="form-group">
	            	<label for="name"><b><h3>Password:</h3></b></label>
